...
<%-- 				<div id="slide-0${i}" class="swiper-slide"><label style="min-height: 250px"><a><img alt="" src="${banner.img}"></a></label></div>
			<c:forEach items="${banners}" var="i">
				...
				<div id="slide-02" class="swiper-slide"><label style="min-height: 250px"><a><img alt="" src="${pageContext.request.contextPath}/static/img/banner/banner_02.png"></a></label></div>
				<div id="slide-03" class="swiper-slide"><label style="min-height: 250px"><a><img alt="" src="${pageContext.request.contextPath}/static/img/banner/banner_03.png"></a></label></div>
				<div id="slide-04" class="swiper-slide"><label style="min-height: 250px"><a><img alt="" src="${pageContext.request.contextPath}/static/img/banner/banner_04.png"></a></label></div>
